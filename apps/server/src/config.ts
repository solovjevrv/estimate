...
export interface Config {
  ...
  /**
   * MinIO (Epic 21) — основной путь для аватарок (21.2) и картинок досок (21.5).
   * Опционален: без него аватары и картинки пишутся на локальный диск
   * (avatarsDir/boardAssetsDir), а для чтения используется legacy-fallback.
   */
