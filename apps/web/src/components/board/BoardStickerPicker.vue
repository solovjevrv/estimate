...
.board-sticker-picker {
  ...
  /* Запас сверх 4×72px+зазоры (312px) + паддинги (20px) — под классический (не
     overlay) скроллбар вертикального скролла ниже, иначе сетка ужимается на
     его ширину и появляется паразитный горизонтальный скролл (нашли по
