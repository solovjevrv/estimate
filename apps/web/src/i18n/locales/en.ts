export default {
  ...
  board: {
    ...
    hotkeysButton: 'Keyboard shortcuts',
    hotkeysTitle: 'Keyboard shortcuts',
    hotkeysClose: 'Got it',
    hotkeysSectionNav: 'Navigation',
    hotkeysSectionEdit: 'Selection & editing',
    hotkeysSectionDrag: 'While dragging',
    hotkeysPan: 'Pan',
    hotkeysWheel: 'Mouse wheel',
    hotkeysZoom: 'Zoom',
    hotkeysWheelOrPinch: 'wheel / pinch',
    hotkeysPanAlt: 'Pan (or middle mouse button)',
    hotkeysDoubleClick: 'Double-click the canvas',
    hotkeysCreateSticky: 'Create a sticky note',
    hotkeysSelectAll: 'Select all',
    hotkeysDuplicate: 'Duplicate selection',
    hotkeysCopy: 'Copy',
    hotkeysPaste: 'Paste',
    hotkeysDelete: 'Delete selection',
    hotkeysUndo: 'Undo',
    hotkeysRedo: 'Redo (or Ctrl+Y)',
    hotkeysResetZoom: 'Reset zoom (100%)',
    hotkeysFitView: 'Fit everything in view',
    hotkeysDeselect: 'Deselect / stop editing',
    hotkeysAxisLock: 'Constrain movement to one axis (hold)',
    hotkeysMeasure: 'Exact distance to nearby objects (hold)',
    ...
    toolGiphy: 'GIF from Giphy',
    toolArrow: 'Arrow',
    toolFrame: 'Frame',
    toolDiagram: 'Diagrams',
    toolDiagramUmlActor: 'Actor',
    toolDiagramUmlUseCase: 'Use case',
    toolDiagramUmlClass: 'Class',
    toolDiagramUmlInterface: 'Interface',
    toolDiagramUmlEnum: 'Enumeration',
    toolDiagramUmlComponent: 'Component',
    toolDiagramUmlDatabase: 'Database',
    toolDiagramBpmnTask: 'Task',
    diagramPickerSearchPlaceholder: 'Search…',
    diagramPickerGroupUml: 'UML',
    diagramPickerGroupBpmn: 'BPMN',
    diagramPickerEmpty: 'Nothing found',
    diagramPropertiesAttributesHeading: 'Attributes',
    diagramPropertiesLiteralsHeading: 'Literals',
    diagramPropertiesOperationsHeading: 'Operations',
    diagramPropertiesAddAttribute: 'Add attribute',
    diagramPropertiesAddLiteral: 'Add literal',
    diagramPropertiesAddOperation: 'Add operation',
    diagramPropertiesRemoveLabel: 'Remove',
    diagramPropertiesNamePlaceholder: 'name',
    diagramPropertiesTypePlaceholder: 'type',
    ...
    stickerPersonalLabel: 'My packs',
    stickerPersonalEmpty: 'No imported packs yet',
    stickerImportButton: 'Import from Telegram',
    stickerImportTitle: 'Import stickers from Telegram',
    stickerImportPlaceholder: 'Link t.me/addstickers/... or pack name',
    stickerImportConsentLabel: 'I consent to using third-party stickers',
    stickerImportConfirm: 'Import',
    stickerImportImporting: 'Importing…',
    stickerImportError: 'Could not import stickers. Check the name and try again.',
    stickerImportInvalidName:
      'Could not recognize the link or name — paste a link like t.me/addstickers/name or the name itself',
    ...
    giphyPickerLabel: 'Replace GIF',
    giphySearchPlaceholder: 'Search GIFs on Giphy',
    giphyUnavailable: 'GIF search is temporarily unavailable',
    giphyNoResults: 'No results found',
    giphyLoadMore: 'Load more',
