export default {
  ...
  board: {
    ...
    shareDescription: 'Anyone with this link can view the board.',
    shareRoleView: 'View only',
    shareRoleEdit: 'View and edit',
    shareDisabled: 'Enable sharing',
    shareEnableView: 'Enable link access (view)',
    shareEnableEdit: 'Enable link access (view and edit)',
    shareDisable: 'Disable link access',
    shareCopied: 'Link copied to clipboard',
    shareError: 'Could not update sharing',
    guestName: 'Your name',
    guestNamePlaceholder: 'Enter your name to view the board',
    forms: {
      sticky: 'Sticky note',
      rectangle: 'Rectangle',
