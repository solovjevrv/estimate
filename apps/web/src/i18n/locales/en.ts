export default {
  ...
  team: {
    ...
    inviteTitle: 'Invite',
    inviteHint:
      'Share the link — people join the team through it. A new link disables the previous one.',
    copy: 'Copy link',
    copied: 'Link copied',
  ...
  room: {
    ...
    disconnectedTitle: 'Room connection lost',
    disconnectedDescription: 'Reconnecting… Your vote is saved.',
    toRooms: 'To rooms',
  ...
  myRooms: {
    title: 'Rooms',
    subtitle: 'Personal and team rooms — everything you have access to',
  ...
  board: {
    ...
    exportButton: 'Export',
    exportTitle: 'Export board',
    exportMarginLabel: 'Margin, px',
    exportSelectedOnlyLabel: 'Selected area only',
    exportDownload: 'Download',
    exportPreparing: 'Preparing PNG',
