export default {
  ...
  home: {
    eyebrow: 'Ваш agile-помощник',
    headline: 'Оценивайте задачи как весёлую игру, а не как совещание',
    lead: 'Соберите команду, откройте комнату и оцените бэклог картами. Быстро, честно и без споров о том, кто что имел в виду.',
    startWithTeam: 'Перейти к командам',
    startAsGuest: 'Войти, чтобы создать комнату',
    bullet1: 'Крупные карты',
    bullet2: 'Гостевой вход по ссылке',
    bullet3: 'Общее пространство команды',
    card1Title: 'Голосуйте картами',
    card1Desc: 'Крупные карты и понятный статус — сразу видно, кто уже сделал выбор.',
    card2Title: 'Подключайтесь без регистрации',
    card2Desc: 'Гость входит по прямой ссылке на комнату и сразу садится за стол.',
    card3Title: 'Общее пространство команды',
    card3Desc: 'Активные и завершённые комнаты команды — в одном месте, доступны всем участникам.',
  },
  login: {
    title: 'Вход',
