export default {
  ...
  board: {
    ...
    shareTitle: 'Доступ по ссылке',
    shareDescription: 'Кто угодно с этой ссылкой сможет смотреть доску.',
    shareRoleView: 'Только просмотр',
    shareRoleEdit: 'Просмотр и правка',
    shareDisabled: 'Поделиться ссылкой',
    shareEnableView: 'Включить доступ по ссылке (просмотр)',
    shareEnableEdit: 'Включить доступ по ссылке (просмотр и правка)',
    shareDisable: 'Отключить доступ по ссылке',
    shareCopied: 'Ссылка скопирована в буфер обмена',
    shareError: 'Не удалось обновить доступ по ссылке',
    guestName: 'Ваше имя',
    guestNamePlaceholder: 'Введите имя, чтобы смотреть доску',
    forms: {
      sticky: 'Стикер',
