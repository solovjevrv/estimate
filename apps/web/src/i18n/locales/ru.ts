export default {
  ...
  board: {
    ...
    hotkeysButton: 'Список горячих клавиш',
    hotkeysTitle: 'Горячие клавиши',
    hotkeysClose: 'Понятно',
    hotkeysSectionNav: 'Навигация',
    hotkeysSectionEdit: 'Выделение и редактирование',
    hotkeysSectionDrag: 'При перетаскивании',
    hotkeysPan: 'Панорамирование',
    hotkeysWheel: 'Колесо мыши',
    hotkeysZoom: 'Масштаб',
    hotkeysWheelOrPinch: 'колесо / pinch',
    hotkeysPanAlt: 'Панорамирование (или средняя кнопка мыши)',
    hotkeysDoubleClick: 'Двойной клик по холсту',
    hotkeysCreateSticky: 'Создать стикер',
    hotkeysSelectAll: 'Выделить всё',
    hotkeysDuplicate: 'Дублировать выделенное',
    hotkeysCopy: 'Копировать',
    hotkeysPaste: 'Вставить',
    hotkeysDelete: 'Удалить выделенное',
    hotkeysUndo: 'Отменить',
    hotkeysRedo: 'Повторить (или Ctrl+Y)',
    hotkeysResetZoom: 'Сбросить масштаб (100%)',
    hotkeysFitView: 'Вписать всё в экран',
    hotkeysDeselect: 'Снять выделение / закрыть редактирование',
    hotkeysAxisLock: 'Ограничить перемещение одной осью (удерживать)',
    hotkeysMeasure: 'Точное расстояние до соседних объектов (удерживать)',
    ...
    toolGiphy: 'GIF из Giphy',
    toolArrow: 'Стрелка',
    toolFrame: 'Фрейм',
    toolDiagram: 'Диаграммы',
    toolDiagramUmlActor: 'Актёр',
    toolDiagramUmlUseCase: 'Вариант использования',
    toolDiagramUmlClass: 'Класс',
    toolDiagramUmlInterface: 'Интерфейс',
    toolDiagramUmlEnum: 'Перечисление',
    toolDiagramUmlComponent: 'Компонент',
    toolDiagramUmlDatabase: 'База данных',
    toolDiagramBpmnTask: 'Задача',
    diagramPickerSearchPlaceholder: 'Поиск…',
    diagramPickerGroupUml: 'UML',
    diagramPickerGroupBpmn: 'BPMN',
    diagramPickerEmpty: 'Ничего не найдено',
    diagramPropertiesAttributesHeading: 'Атрибуты',
    diagramPropertiesLiteralsHeading: 'Литералы',
    diagramPropertiesOperationsHeading: 'Операции',
    diagramPropertiesAddAttribute: 'Добавить атрибут',
    diagramPropertiesAddLiteral: 'Добавить литерал',
    diagramPropertiesAddOperation: 'Добавить операцию',
    diagramPropertiesRemoveLabel: 'Удалить',
    diagramPropertiesNamePlaceholder: 'имя',
    diagramPropertiesTypePlaceholder: 'тип',
    umlVisibilityPublic: 'public',
    umlVisibilityPrivate: 'private',
    umlVisibilityProtected: 'protected',
    umlVisibilityPackage: 'package',
    ...
    giphyPickerLabel: 'Заменить GIF',
    giphySearchPlaceholder: 'Поиск GIF в Giphy',
    giphyUnavailable: 'Поиск GIF временно недоступен',
    giphyNoResults: 'Ничего не найдено',
    giphyLoadMore: 'Показать ещё',
    frameTitlePlaceholder: 'Заголовок фрейма',
    frameSizeLabel: 'Размер фрейма',
    frameSizePresets: {
      custom: 'Свободный',
      a4: 'A4',
      letter: 'Letter',
