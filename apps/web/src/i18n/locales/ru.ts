export default {
  ...
  team: {
    ...
    membersTitle: 'Состав',
    invite: 'Пригласить',
    teamMenu: 'Действия с командой',
    inviteTitle: 'Приглашение',
    inviteHint:
      'Отправьте ссылку — по ней присоединятся к команде. Новая ссылка отключит предыдущую.',
  ...
  room: {
    ...
    disconnectedTitle: 'Связь с комнатой потеряна',
    disconnectedDescription: 'Переподключаемся… Ваш голос сохранён.',
    toRooms: 'К комнатам',
  ...
  myRooms: {
    title: 'Комнаты',
    subtitle: 'Личные и командные комнаты — всё, что вам доступно',
  ...
  board: {
    ...
    exportMarginLabel: 'Отступы от края, px',
    exportSelectedOnlyLabel: 'Только выделенную область',
    exportDownload: 'Скачать',
    exportPreparing: 'Готовим PNG',
    exportPreparingItemCount: 'Собираем элементы: {count}',
