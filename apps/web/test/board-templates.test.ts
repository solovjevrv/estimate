...
const template: BoardTemplate = {
  ...
  items: [
    ...
    {
      key: 'start-note',
      parentKey: 'start-frame',
      content: { type: 'sticky', text: 'Что стоит начать делать?' },
      x: 100,
      y: 30,
      width: 180,
      height: 120,
    ...
    {
      key: 'stop-note',
      parentKey: 'stop-frame',
      content: { type: 'sticky', text: 'Что стоит прекратить делать?' },
      x: 520,
      y: 30,
      width: 180,
      height: 120,
    ...
    },
    {
      key: 'continue-frame',
      parentKey: null,
      content: { type: 'frame', title: 'Continue' },
      x: 840,
      y: 0,
      width: 380,
      height: 480,
    ...
    {
      key: 'continue-note',
      parentKey: 'continue-frame',
      content: { type: 'sticky', text: 'Что стоит продолжать делать?' },
      x: 940,
      y: 30,
      width: 180,
      height: 120,
