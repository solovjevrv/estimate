...
export interface JoinBoardPayload {
  ...
  guestToken?: string;
  /** Клиент сообщает клиентскую версию, поддерживает ли диаграммы; сервер использует это для отсечки операций diagram у старых клиентов (rollout-совместимость) */
