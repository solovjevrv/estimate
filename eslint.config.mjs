...
export default tseslint.config(
  ...
  },
  {
     ...
     */
    files: [
      // 17.1: 2984 → 989 строк (728 без учёта комментариев/пустых) — композиция
      // уже тонкая, дальнейшее выжимание рискует сломать auto-unwrap рефов в
      // шаблоне (useBoardEdges возвращает обычный объект, не reactive()).
      // Остаток — 28 строк сверх порога, не открывать заново без веской причины.
